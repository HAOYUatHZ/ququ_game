  ...
  data() {
    return {
      ...
      menus: [
        ...
        {
          name: 'header.nav.cricketFactory',
          to: { name: 'CricketFactory' }
        },
        {
          name: 'header.nav.myCricket',
          to: { name: 'MyCricket' }
        },
        {
          name: 'header.nav.cricketFight',
          to: { name: 'CricketFight' }
        },
        {
          name: 'header.nav.cricketMarket',
          to: { name: 'CricketMarket' }
        }
      ]
    };
  },
